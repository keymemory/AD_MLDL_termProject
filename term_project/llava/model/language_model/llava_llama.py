...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config, visual_token_num, important_ratio,
        ...
        self.visual_token_num = visual_token_num   # = 최종 토큰 수 M2
        self.important_ratio = important_ratio

        # [Two-Stage] Stage 2 clustering config
        self.enable_clustering = enable_clustering
        # stage1_tokens(M1): None이면 M2와 동일(=clustering 무효, 기존 VisPruner)
    ...
    # [Two-Stage] Stage 2 clustering getters
    def get_enable_clustering(self):
        return getattr(self, "enable_clustering", False)

    def get_stage1_tokens(self):
        return getattr(self, "stage1_tokens", self.visual_token_num)

    def get_merge_method(self):
        return getattr(self, "merge_method", "simple_avg")
