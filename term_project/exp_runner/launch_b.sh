...
echo "Jobs: exp_runner/exp_jobs_scaling_b.tsv"
echo "GPU 0 로그: /tmp/worker_b_g0.log"
echo "GPU 1 로그: /tmp/worker_b_g1.log"
echo "결과: $RES"
echo ""

nohup bash exp_runner/worker_b.sh 0 > /tmp/nohup_b_g0.log 2>&1 &
PID0=$!
echo "GPU 0 worker PID: $PID0"

nohup bash exp_runner/worker_b.sh 1 > /tmp/nohup_b_g1.log 2>&1 &
PID1=$!
