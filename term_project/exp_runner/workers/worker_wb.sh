...
# 사용: bash exp_runner/workers/worker_wb.sh <GPU_INDEX> [jobs_file]
set -u

GPU="${1:?GPU index required}"
JOBS="${2:-exp_runner/jobs/exp_jobs_scaling_wb.tsv}"
...
RES=$TP/exp_runner/results/results_scaling_wb.tsv
