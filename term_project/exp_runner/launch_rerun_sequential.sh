...
# 사용: nohup bash exp_runner/launch_rerun_sequential.sh > /tmp/rerun_all.log 2>&1 &
...
bash exp_runner/worker_wb.sh 0 >> /tmp/rerun_wb_g0.log 2>&1 &
PID_WB0=$!
bash exp_runner/worker_wb.sh 1 >> /tmp/rerun_wb_g1.log 2>&1 &
PID_WB1=$!
...
bash exp_runner/worker_wc.sh 0 >> /tmp/rerun_wc_g0.log 2>&1 &
PID_WC0=$!
bash exp_runner/worker_wc.sh 1 >> /tmp/rerun_wc_g1.log 2>&1 &
PID_WC1=$!
...
bash exp_runner/worker_wd.sh 0 >> /tmp/rerun_wd_g0.log 2>&1 &
PID_WD0=$!
bash exp_runner/worker_wd.sh 1 >> /tmp/rerun_wd_g1.log 2>&1 &
PID_WD1=$!
...
log "=== 전체 재실행 완료 ==="
log "결과 확인:"
log "  W-B: wc -l exp_runner/results_scaling_wb.tsv"
log "  W-C: wc -l exp_runner/results_scaling_wc.tsv"
log "  W-D: wc -l exp_runner/results_scaling_wd.tsv"
