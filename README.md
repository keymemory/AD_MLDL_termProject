...
> **AGG 재현:** parameter-free Attention Gain + Greedy diversity Gain 구현, 네 벤치마크 재현 절차, POPE weighted latency 재현은 [`vispruner_md/exp2/README.md`](vispruner_md/exp2/README.md)를 참조하세요. 공개 브랜치는 `agg-token-selection`입니다.
